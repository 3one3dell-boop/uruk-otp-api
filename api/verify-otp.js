...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // معرّف المشروع مو سرّي (موجود أصلاً بإعدادات موقعك العامة) — نرجعه للتشخيص فقط
    return res.status(200).json({ ok: true, customToken: customToken, uid: uid, phone: phone, isNew: isNew, usedProjectId: process.env.FIREBASE_PROJECT_ID || null });
  } catch (e) {
